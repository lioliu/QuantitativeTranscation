...
namespace QuantTradeDLL
{
    ...
    public class HttpHelper
    {
        ...
        #region Public
        /// <summary>
        /// get the page by web item given
        /// </summary>
        ...
        public HttpResult GetHtml(HttpItem item)
        {
            ...
            {
                return new HttpResult() { Cookie = string.Empty, Header = null, Html = ex.Message, StatusDescription = $"error when set the paramater：{ex.Message}" };
            }
            try
            {
                //ask data
